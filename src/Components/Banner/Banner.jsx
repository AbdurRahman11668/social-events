const Banner = () => {
  return (
    <div className="carousel w-full">
      <div id="slide1" className="carousel-item relative w-full min-h-[400px]">
        ...
        <div className="absolute text-center space-y-10 transform -translate-y-1/2 left-5 right-5 top-1/2">
          <h2 className="text-8xl font-bold text-teal-600">Welcome</h2>
      ...
      <div id="slide2" className="carousel-item relative w-full">
        ...
        />
        <div className="absolute text-center space-y-10 transform -translate-y-1/2 left-5 right-5 top-1/2">
          <h2 className="text-8xl font-bold text-pink-600">Welcome</h2>
      ...
      <div id="slide3" className="carousel-item relative w-full">
        ...
        />
        <div className="absolute text-center space-y-10 transform -translate-y-1/2 left-5 right-5 top-1/2">
          <h2 className="text-8xl font-bold text-sky-600">Welcome</h2>
          <p className="text-3xl font-bold text-sky-800">
      ...
      <div id="slide4" className="carousel-item relative w-full">
        ...
        />
        <div className="absolute text-center space-y-10 transform -translate-y-1/2 left-5 right-5 top-1/2">
          <h2 className="text-8xl font-bold text-red-700">Welcome</h2>
